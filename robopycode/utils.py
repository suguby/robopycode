...
def in_radar_fork(obj, target):
    ...
    """
    half_radar_angle = theme.TANK_RADAR_ANGLE // 2
    radar_point_back_distance = obj.radius

    point_back_vector = Vector.from_direction(obj.vector.direction + 180, radar_point_back_distance)
    ...
    left_radar_angle = normalise_angle(obj.vector.direction + half_radar_angle)
    right_radar_angle = normalise_angle(obj.vector.direction - half_radar_angle)
